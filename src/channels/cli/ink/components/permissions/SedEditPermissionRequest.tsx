// SedEditPermissionRequest.tsx — SPEC-846 stub for v0.4.1.
...
export function SedEditPermissionRequest(_props: PermissionDialogProps): React.ReactElement {
  throw new NimbusError(ErrorCode.T_NOT_IMPLEMENTED, {
    component: 'SedEditPermissionRequest',
    deferredTo: 'v0.4.1',
    spec: 'SPEC-846',
  });
}
